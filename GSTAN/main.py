...
n_train, n_test = 0.05, 0.95
PeMS = data_gen(pjoin('data_loader/PeMS-M/PeMS-M', data_file), (n_train, n_test), n, n_his, n_pred)
print(f'>> Loading dataset with Mean: {PeMS.mean:.2f}, STD: {PeMS.std:.2f}')

if __name__ == '__main__':
    model_train(PeMS, blocks, args)
    model_test(PeMS, int(PeMS.get_len('test')*0.01), n_his, n_pred, args.inf_mode)
